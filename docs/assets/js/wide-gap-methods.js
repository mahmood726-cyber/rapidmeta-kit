...
(function () {
  ...
  var WideGap = { CNMA: CNMA, RegPubBias: RegPubBias, BenefitRisk: BenefitRisk, TSAPipeline: TSAPipeline,
    renderAll: function () { [CNMA, RegPubBias, BenefitRisk, TSAPipeline].forEach(function (m) { try { m.render(); } catch (e) {} }); } };
